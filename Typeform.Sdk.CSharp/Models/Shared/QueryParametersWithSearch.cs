...
{
    /// <summary>
    ///     Query Parameters with Search
    /// </summary>
    public class QueryParametersWithSearch
    {
        private QueryParametersWithSearch()
        {
        }
        ...
        /// <returns></returns>
        public static QueryParametersWithSearch Create(string searchFilter = "", int page = 1, int pageSize = 10)
        {
            return new QueryParametersWithSearch().SetPage(page).SetPageSize(pageSize).SetSearchFilter(searchFilter);
        }
        ...
        /// <returns></returns>
        public QueryParametersWithSearch SetPageSize(int pageSize)
        {
        ...
        /// <returns></returns>
        public QueryParametersWithSearch SetPage(int page)
        {
        ...
        /// <returns></returns>
        public QueryParametersWithSearch SetSearchFilter(string searchFilter)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public QueryParametersWithSearch ClearSearchFilter()
        {
